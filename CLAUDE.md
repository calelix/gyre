...
- [docs/slices.md](docs/slices.md), [docs/select.md](docs/select.md) — current slicing-methodology state. Produced by the slicer skills; may be absent if the methodology hasn't been run yet or has been reset between cycles.
- [docs/issues/](docs/issues/) — failure records; see the [README](docs/issues/README.md) inside for the entry convention.

Generated artifacts (component specs from skills) live at `docs/gyre/specs/components/<kebab-name>.md` when produced.
